...
class Database(object):
    ...
    @staticmethod
    def deletetable(collection:str):
        URL = "https://{}-{}.apps.astra.datastax.com/api/rest/v2/schemas/keyspaces/{}/tables/{}".format(Database.ASTRA_DB_ID,
    ...
    @staticmethod
    def createudt(jsonobj:dict):
        URL = "https://{}-{}.apps.astra.datastax.com/api/rest/v2/schemas/keyspaces/{}/types".format(Database.ASTRA_DB_ID,
                                                                                                    Database.ASTRA_DB_REGION,
                                                                                                    Database.ASTRA_DB_KEYSPACE)
        HEADER={"content-type": "application/json",
                "x-cassandra-token": Database.ASTRA_DB_APPLICATION_TOKEN
    ...
    @staticmethod
    def updatecolumn(jsonobj:dict,collection:str,column:str):
        URL = "https://{}-{}.apps.astra.datastax.com/api/rest/v2/schemas/keyspaces/{}/tables/{}/columns/{}".format(Database.ASTRA_DB_ID,
                                                                                                    Database.ASTRA_DB_REGION,
                                                                                                    Database.ASTRA_DB_KEYSPACE,
                                                                                                    collection,
                                                                                                    column)
        ...
        PAYLOAD = json.dumps(jsonobj)
        request = requests.put(URL,data=PAYLOAD,headers=HEADER)
        return request.json()